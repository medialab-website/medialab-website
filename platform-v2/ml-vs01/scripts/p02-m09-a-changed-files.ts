export const P02_M09_A_ALLOWLIST: readonly string[] = [
  'platform-v2/ml-vs01/BUILD_STATE.md',
  'platform-v2/ml-vs01/CHANGED_FILES.md',
  'platform-v2/ml-vs01/db/fixtures/durable-media-operations-reconciliation-fixtures.ts',
  'platform-v2/ml-vs01/db/migrate.ts',
  'platform-v2/ml-vs01/db/migrations/0012_durable_media_operations_reconciliation_foundation.sql',
  ...
  'platform-v2/ml-vs01/scripts/p02-m09-a-changed-files.ts',
