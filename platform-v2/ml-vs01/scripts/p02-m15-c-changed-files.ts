export const P02_M15_C_ALLOWLIST: readonly string[] = [
...
if (P02_M15_C_ALLOWLIST.length !== 64 || new Set(P02_M15_C_ALLOWLIST).size !== 64) {
  throw new Error('P02-M15-C packet allowlist must contain exactly 64 unique paths');
}
