export const P02_M15_D_ALLOWLIST: readonly string[] = [
...
if (P02_M15_D_ALLOWLIST.length !== 61 || new Set(P02_M15_D_ALLOWLIST).size !== 61) {
  throw new Error('P02-M15-D packet allowlist must contain exactly 61 unique paths');
}
