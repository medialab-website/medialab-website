export const P02_M15_E_ALLOWLIST: readonly string[] = [
...
if (P02_M15_E_ALLOWLIST.length !== 61 || new Set(P02_M15_E_ALLOWLIST).size !== 61) {
  throw new Error('P02-M15-E packet allowlist must contain exactly 61 unique paths');
}
