...
if (JSON.stringify([...actualGitFiles].sort()) !== JSON.stringify([...P02_M14_A_ALLOWLIST].sort())) {
  console.error('ERROR: Actual Git candidate files do not exactly match the P02-M14-A allowlist.');
  process.exit(1);
}
