...
if (JSON.stringify([...actualGitFiles].sort()) !== JSON.stringify([...P02_M15_B_ALLOWLIST].sort())) {
  console.error('ERROR: Actual Git candidate files do not exactly match the P02-M15-B allowlist.');
  process.exit(1);
}
