...
if (JSON.stringify([...actualGitFiles].sort()) !== JSON.stringify([...P02_M15_D_ALLOWLIST].sort())) {
  console.error('ERROR: Actual Git candidate files do not exactly match the P02-M15-D allowlist.');
  process.exit(1);
}
