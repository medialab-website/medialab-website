...
if (migrations.length !== 27 || migrations[0]?.slice(0, 4) !== "0001" || migrations[22] !== "0023_runtime_intake_reconciliation_commands.sql" || migrations[23] !== "0024_operations_home_scheduling_assignment_console.sql" || migrations[24] !== "0025_operations_mission_plan_draft_controls.sql" || migrations[25] !== "0026_editorial_segment_foundation.sql" || migrations[26] !== "0027_contextual_editor_review_mobile_quick_edit_web_bridge.sql") fail("migration inventory changed");
