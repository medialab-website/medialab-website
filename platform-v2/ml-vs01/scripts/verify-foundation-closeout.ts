...
// 1. P02-M16-C bounded changed-file maximum allowlist
const ALLOWLIST = [...P02_M16_C_ALLOWLIST];
...
for (const line of lines) {
  ...
  if (!ALLOWLIST.includes(gitPath)) {
    console.error(`ERROR: Changed file '${gitPath}' is outside the P02-M16-C 16-path allowlist.`);
    errors = true;
  }
