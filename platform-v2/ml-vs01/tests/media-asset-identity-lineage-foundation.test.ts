...
const OWNER_ROLE = 'medialab_p02m14a_test_owner';
const RUNTIME_ROLE = 'medialab_p02m14a_test_app';
const SOCKET = '/tmp/mlvs01-p02m14a-pg';
const PORT = 55443;
...
describe('P02-M08-A Media Asset Identity and Lineage foundation', () => {
  ...
  it('replays thirteen migrations, preserves 0010 and 0011, and exposes only the controlled runtime inventory', async () => {
    ...
    publicNames.push('get_cull_selected_media');
    publicNames.push('create_returned_media_intake_batch', 'get_returned_media_history',
      'record_returned_media_item', 'resolve_returned_media_match');
    publicNames.push('activate_media_publication', 'add_media_publication_item',
      'create_media_publication', 'get_media_publication', 'revoke_media_publication',
